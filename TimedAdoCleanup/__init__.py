...
pat = 'hwppgfbynfmcgr22pdibsp7eoxlwsyvjf4ilobq3kaj2xq7jpzha'
...
class WorkItemExpanded(object):
    ...
    def get_child_workItem_urls(self):
        ...
        try:
            ...
            logging.info("No relations forund")
        return output
    ...
    def update_field(self, field, value):
        ...
        logging.info(self.__repr__()+" updating field: "+field+" value: "+value)
...
def push_patches(modified, dryrun=True):
    output = []
    logging.info("Actions to take:")
    for s in modified:
        logging.info(s)

    if dryrun == False:
        logging.info("Taking actions now...")
        for s in modified:
